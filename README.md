...
**Template for Unity 6000.3.12f1**  
**Editor Install** - https://unity.com/releases/editor/whats-new/6000.3.12f1#installs
...
- **Optional**
	- **Include base scripts in new namepsace and rename product:** `Tools` -> `Replace Namespace` input new name.
